...
from models.utils import load_ds
...
# Create the model
model = get_base_model(NUM_CLASSES)  # Also used with the CC'd FC4 dataset
# model = get_batchnorm_model(NUM_CLASSES)
# model = get_cc_model(NUM_CLASSES, grey_world_layer)
# model = get_cc_model(NUM_CLASSES, grey_edge_layer)
# model = get_cc_model(NUM_CLASSES, white_patch_layer)
