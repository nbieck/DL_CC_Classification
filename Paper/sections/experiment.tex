...
As for our custome classifier,  The architecture of our implemented network includes a sequence of layers. Which essentially follows a common Convolutional Neural Network Architecture (CNN) 
