...
We observe similar results with the larger of the two datasets, with color corrected data having similar or worse performance to the unprocessed baseline.