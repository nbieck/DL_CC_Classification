...
\begin{table}
    ...
    \caption{Summary data obtained from running our model on the 17 flowers dataset.}
...
\begin{table}
    ...
    \caption{Summary data obtained from running VGG16 with the 17 flowers dataset.}
